...
namespace Webapp2.Models
{
    ...
    public partial class northwinddbEntities : DbContext
    {
        ...
        public virtual ObjectResult<Customer> CustomersByCountry(string country)
        {
            var countryParameter = country != null ?
                new ObjectParameter("Country", country) :
                new ObjectParameter("Country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Customer>("CustomersByCountry", countryParameter);
        }
    
        public virtual ObjectResult<Customer> CustomersByCountry(string country, MergeOption mergeOption)
        {
            var countryParameter = country != null ?
                new ObjectParameter("Country", country) :
                new ObjectParameter("Country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Customer>("CustomersByCountry", mergeOption, countryParameter);
        }
    }
}
